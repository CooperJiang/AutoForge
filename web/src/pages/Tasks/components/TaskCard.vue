          ...
          >
            <div class="flex items-start justify-between gap-3">
              <div class="flex-1 min-w-0">
                ...
                <div v-if="log.error_message" class="mt-1.5 p-2 bg-rose-50 rounded text-xs text-rose-700">
                  {{ log.error_message }}
                </div>
                <div v-if="log.response_body" class="mt-2">
                  <details class="group/details">
                    <summary class="cursor-pointer text-xs font-medium text-emerald-600 hover:text-emerald-700 select-none list-none">
                      <span class="inline-flex items-center gap-1">
                        <span class="group-open/details:rotate-90 transition-transform inline-block">▶</span>
